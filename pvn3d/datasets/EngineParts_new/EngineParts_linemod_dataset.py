...
class LM_Dataset():
    ...
    def __init__(self, dataset_name, cls_type="3d_fuel_line2"):
        self.config = Config(dataset_name='EngineParts', cls_type=cls_type)
        ...
        print("cls_id in WRONGlm_dataset.py", self.cls_id)
        self.root = os.path.join(self.config.EngineParts_root, 'EngineParts')
