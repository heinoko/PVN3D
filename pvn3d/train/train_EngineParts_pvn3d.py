...
from datasets.EngineParts.EngineParts_dataset import EngineParts_Dataset
...
def model_fn_decorator(
    ...
    def model_fn(
        ...
        with torch.set_grad_enabled(not is_eval):
            ...
            print('rgb type '+str(rgb.cpu().numpy().dtype))
...
if __name__ == "__main__":
    ...
    if not args.eval_net:
        # train_ds = openDR_Dataset('train')
        train_ds = EngineParts_Dataset('train')
        '''
        #############################################################
