        ...
        with torch.set_grad_enabled(not is_eval):
            ...
            if is_test:
                pred_pose_lst,pred_kps_lst,_,_2 = teval.eval_pose_parallel(
                    ...
                    use_ctr=True, ds_type="CrankSlider"
                )
        ...
        for i, data in tqdm.tqdm(
            ...
            while not rospy.is_shutdown():
                ...
                if pose.shape[0]>cls:
                    ...
                    p2ds_rgb = bs_utl.project_p3d(p3d_rgbs, 1 , K = config.intrinsic_matrix['CrankSlider'] )
                    #print(p2ds.shape)
...
if __name__ == "__main__":
    ...
    corners_t = np.zeros((8,8,3))       #np.zeros((10,8,3))  for 10 objects
    for i in range(0,8):
        corners = np.loadtxt('/home/ahmad3/PVN3D/pvn3d/datasets/CrankSlider/CrankSlider_object_kps/'+str(i+1)+'/corners.txt')
